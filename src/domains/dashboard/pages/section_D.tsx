...
“GUIDELINE ON CREDIT TRANSACTION AND EXPOSURES WITH CONNECTED PARTIES”`}
          ...
          <FormControlLabel
            ...
            label={
              <Typography
                ...
                style={{ color: "#151515" }}
              >
                I understand that I shall also be responsible to update, in the
                for of additions, removal, or changes to the information from
                time to time or as required.
              </Typography>
            }
          />
        ...
        <Box>
          ...
          <Typography fontSize="12px" fontWeight="400" color="#151515">
            *For more information, please refer to the BNM Guidelines and Group
            Credits Guidelines Section 4.2.9 on Credit Transaction and Exposures
